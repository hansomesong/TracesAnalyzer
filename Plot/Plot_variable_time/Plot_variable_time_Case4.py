...
plt.annotate('04/07/2013  15:30:25',xy=(107,1.95),xytext=(107,1.75),arrowprops=dict(arrowstyle="->"))
plt.annotate('04/07/2013 20:30:43',xy=(117,2.03),xytext=(117,2.15),arrowprops=dict(arrowstyle="->"))
...
plt.savefig("/Users/yueli/Documents/Codes/TracesAnalyzer/Plot/Plot_variable_time/Case4.pdf")
plt.show()
