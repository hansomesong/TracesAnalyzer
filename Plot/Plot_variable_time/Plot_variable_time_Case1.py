...
plt.title("Response from MR-149.20.48.61 for EID-37.77.57.64 by time")

plt.annotate('2013/07/10 02:30',xy=(375,3),xytext=(375,3.1),arrowprops=dict(arrowstyle="->"))

plt.savefig("/Users/yueli/Documents/Codes/TracesAnalyzer/Plot/Plot_variable_time/Case1.pdf")
plt.show()
