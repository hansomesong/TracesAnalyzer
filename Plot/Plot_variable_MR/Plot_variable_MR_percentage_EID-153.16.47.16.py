...
plt.bar(mr, listResult_trans[3], bar_width, color="yellow", label="No Map Reply")
# plt.bar(mr, listResult_trans[2], bar_width, color="red", label="Negative Reply")
plt.bar(mr, listResult_trans[1], bar_width, color="green", label="RLOC-195.59.156.124")
plt.bar(mr, listResult_trans[0], bar_width, color="orange", label="RLOC-195.59.156.123")
plt.xlabel('13 map resolvers')
plt.ylabel('percentage of every Map Reply (%)')
plt.title('Percentage of different Map Replies for EID-153.16.47.16 from 13 MRs')
...
plt.savefig(os.path.join(PLOT_DIR, 'Plot_variable_MR', 'Plot_variable_MR_percentage_EID-153_16_47_16.eps'),
