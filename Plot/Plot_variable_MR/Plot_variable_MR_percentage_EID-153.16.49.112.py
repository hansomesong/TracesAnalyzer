    ...
    for line in open(rawCSV_file):
        ...
        if lines[0] == "Round Type":
            ...
            if lines[0] == "RoundNoReply":
                ...
                if (lines[14].split(',')[1] == "82.121.231.67") or (lines[20] == "82.121.231.67"):
                    rlocSet1 = rlocSet1 + 1
                elif (lines[14].split(',')[1] == "192.168.1.66") or (lines[20] == "192.168.1.66"):
                    rlocSet2 = rlocSet2 + 1
                elif (lines[14].split(',')[1] == "132.227.85.231") or (lines[20] == "132.227.85.231"):
                    rlocSet3 = rlocSet3 + 1

            elif int(lines[9]) == 3:
                if (lines[14].split(',')[1] == "82.121.231.67") or (lines[20] == "82.121.231.67") or (lines[25] == "82.121.231.67"):
                    rlocSet1 = rlocSet1 + 1
                elif (lines[14].split(',')[1] == "192.168.1.66") or (lines[20] == "192.168.1.66") or (lines[25] == "192.168.1.66"):
                    rlocSet2 = rlocSet2 + 1
                elif (lines[14].split(',')[1] == "132.227.85.231") or (lines[20] == "132.227.85.231") or (lines[25] == "132.227.85.231"):
                    rlocSet3 = rlocSet3 + 1
...
# plt.savefig(os.path.join(PLOT_DIR, 'Plot_variable_MR', 'Plot_variable_MR_percentage95.eps'),
