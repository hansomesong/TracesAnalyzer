...
plt.scatter(time, responseLists1[0], marker=".", s=700, color='black', label = "RLOC1")
plt.scatter(time, responseLists2[0], marker="*", s=700, color='gray', label = "RLOC2")

for responseList in responseLists1:
     plt.scatter(time, responseList, marker=".", s=700, color='black')

for responseList in responseLists2:
     plt.scatter(time, responseList, marker="*", s=700, color='gray')
...
#             dpi=300)
plt.savefig(os.path.join(PLOT_DIR, 'Plot_newSize', 'Normal_from_13_different_MRs_for_EID-153_16_47_16_over_time_label_inconsistent_zoom.eps'),
