...
if __name__ == '__main__':
    ...
    pl.xlabel("experiment number", font_label)
    pl.ylabel("change number", font_label)
    plt.xticks(fontsize=45, fontname='Times New Roman')
    plt.yticks(fontsize=45, fontname='Times New Roman')
    pl.xlim(0,len(sig))
    pl.legend()
    ...
    # pl.xlabel('frequency(Hz)', font_label)
    # pl.ylabel('proportion', font_label)
    # pl.xlim(0,Freq_max)
    # # 用于 New Deployment
    # # pl.ylim(0, 0.3)
    # # 用于所有 change number
    ...
    # plt.ylim(-0.4, 0.61)
    # plt.xlabel("order from 1 to n/2-1", font_label)
    # plt.ylabel("coefficient of Auto-correlation", font_label)
    # plt.xticks(fontsize=45, fontname='Times New Roman')
    # plt.yticks(fontsize=45, fontname='Times New Roman')
    ...
    plt.savefig(os.path.join(PLOT_DIR, 'Plot_newSize', 'Change_number_by_exp_num_all.eps'), dpi = 300, Transarent=True)
    # plt.savefig(os.path.join(PLOT_DIR, 'Plot_newSize', 'Period_verified_by_FFT_all.eps'), dpi = 300, Transarent=True)
    # plt.savefig(os.path.join(PLOT_DIR, 'Plot_newSize', 'Period_verified_by_Autocorrelation_all.eps'), dpi = 300, Transarent=True)
    # plt.show()
