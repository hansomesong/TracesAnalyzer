...
plt.ylabel("responses from MR", font_label)
...
plt.yticks(np.linspace(0, 70, 8), ['No Map-\nReply', 'RLOC10', 'RLOC20', 'RLOC30', 'RLOC40', 'RLOC50', 'RLOC60', 'RLOC70'], fontsize=45, fontname='Times New Roman')

# plt.annotate('No Map Reply',xy=(300,0),xytext=(300,4),arrowprops=dict(arrowstyle="->"))

plt.savefig(os.path.join(PLOT_DIR, 'Plot_newSize', 'Case4-3.eps'), dpi=300, transparent=True)
# plt.show()