...
plt.scatter(time, rlocSet1_1, color='purple', marker="o", label="VP1", s=700)
plt.scatter(time, rlocSet1_2, color='purple', marker='o', s=700)
plt.scatter(time, rlocSet2_1, color='green', marker='>', label="VP2", s=700)
plt.scatter(time, rlocSet2_2, color='green', marker='>', s=700)
plt.scatter(time, rlocSet3_1, color='red', marker=(5,0), label = "VP3", s=700)
plt.scatter(time, rlocSet3_2, color='red', marker=(5,0), s=700)
plt.scatter(time, rlocSet4_1, color='orange', marker='*', label = "VP4", s=700)
plt.scatter(time, rlocSet4_2, color='orange', marker='*', s=700)
plt.scatter(time, rlocSet5_1, color='blue', marker='+', label = "VP5", s=700)
plt.scatter(time, rlocSet5_2, color='blue', marker='+', s=700)
...
plt.yticks(response, ('Negative\nMap-Reply', 'No Map-Reply', 'RLOC 1', 'RLOC 2', 'RLOC 3', 'RLOC 4',
                      'RLOC 5', 'RLOC 6', 'RLOC 7', 'RLOC 8', 'RLOC 9', 'RLOC 10',
                      'RLOC 11', 'RLOC 12', 'RLOC 13'), fontsize=45, fontname='Times New Roman')
...
plt.savefig(
    os.path.join(PLOT_DIR, 'Plot_newSize', 'Plot_variable_VP_different_types.eps'),
