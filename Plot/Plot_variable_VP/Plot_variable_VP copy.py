...
# plt.plot(time, rlocSet1_1, color='blue', label="liege")
# plt.plot(time, rlocSet1_2, color='blue')
# plt.plot(time, rlocSet2_1, color='green', label="temple")
# plt.plot(time, rlocSet2_2, color='green')
# plt.plot(time, rlocSet3_1, color='red', label = "ucl")
# plt.plot(time, rlocSet3_2, color='red')
# plt.plot(time, rlocSet4_1, color='purple', label = "umass")
# plt.plot(time, rlocSet4_2, color='purple')
# plt.plot(time, rlocSet5_1, color='yellow', label="wiilab")
