...
# plt.scatter(time, rlocSet1_1, color='blue', label="liege", s=1)
# plt.scatter(time, rlocSet1_2, color='blue', s=1)
# plt.scatter(time, rlocSet2_1, color='green', label="temple", s=1)
# plt.scatter(time, rlocSet2_2, color='green', s=1)
# plt.scatter(time, rlocSet3_1, color='red', label = "ucl", s=1)
# plt.scatter(time, rlocSet3_2, color='red', s=1)
# plt.scatter(time, rlocSet4_1, color='purple', label = "umass", s=1)
# plt.scatter(time, rlocSet4_2, color='purple', s=1)
# plt.scatter(time, rlocSet5_1, color='yellow', label="wiilab", s=1)
# plt.scatter(time, rlocSet5_2, color='yellow', s=1)
...
plt.savefig("/Users/yueli/Documents/Codes/TracesAnalyzer/Plot/Plot_variable_VP/Plot_variable_VP_subplot.png")
plt.show()