...
plt.scatter(time, rlocSet1_1, color='purple', marker="o", label="VP1", s=200)
plt.scatter(time, rlocSet1_2, color='purple', marker='o', s=200)
plt.scatter(time, rlocSet2_1, color='green', marker='>', label="VP2", s=200)
plt.scatter(time, rlocSet2_2, color='green', marker='>', s=200)
plt.scatter(time, rlocSet3_1, color='red', marker=(5,0), label = "VP3", s=200)
plt.scatter(time, rlocSet3_2, color='red', marker=(5,0), s=200)
plt.scatter(time, rlocSet4_1, color='orange', marker='*', label = "VP4", s=200)
plt.scatter(time, rlocSet4_2, color='orange', marker='*', s=200)
plt.scatter(time, rlocSet5_1, color='blue', marker='+', label = "VP5", s=200)
plt.scatter(time, rlocSet5_2, color='blue', marker='+', s=200)
...
plt.yticks(response, ('Negative\nMap-Reply', 'No Map-Reply', 'RLOC 1', 'RLOC 2', 'RLOC 3', 'RLOC 4',
                      ...
                      'RLOC 11', 'RLOC 12', 'RLOC 13'), fontsize=26)
