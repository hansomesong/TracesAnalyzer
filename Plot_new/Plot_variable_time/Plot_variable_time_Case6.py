...
rawCSV_file = "/Users/yueli/Documents/Codes/TracesAnalyzer/log/log2csv/planetlab1-EID-37.77.57.64-MR-149.20.48.61.log.csv"
...
plt.ylabel("Numbers of Locator")
plt.title("Response from MR-149.20.48.61 for EID-37.77.57.64 by time at liege")
plt.yticks([2, 3], ['2 Locators', '3 Locators'])
plt.xlim(0,755)
plt.ylim(0,4)

plt.annotate('2013/07/10 02:30',xy=(375,3),xytext=(375,3.1),arrowprops=dict(arrowstyle="->"))

# plt.savefig("/Users/yueli/Documents/Codes/TracesAnalyzer/Plot_new/Plot_variable_time/Case6.pdf")
plt.show()
