...
plt.ylabel("pdf (%)")
plt.title("Pdf of the duration in which the same Locator is used")


plt.savefig("/Users/yueli/Documents/Codes/TracesAnalyzer/Plot_new/Plot_variable_time/Case5_pdf_scatter.pdf")
plt.show()