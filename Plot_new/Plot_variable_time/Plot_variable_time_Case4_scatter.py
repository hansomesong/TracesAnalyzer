...
plt.title("Response from MR-149.20.48.61 for EID-153.16.47.16 by time")
plt.yticks([0, 1, 2], ['No Map Reply', '195.59.156.123', '195.59.156.124'])
plt.xlim(0,801)
plt.ylim(-0.2, 2.2)

# plt.savefig("/Users/yueli/Documents/Codes/TracesAnalyzer/Plot_new/Plot_variable_time/Case4_scatter.pdf")
plt.show()