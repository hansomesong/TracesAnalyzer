...
plt.bar(mr, listResult_trans[4], bar_width, color="green", label="rlocSet3")
plt.bar(mr, listResult_trans[3], bar_width, color="red", label="rlocSet2")
plt.bar(mr, listResult_trans[2], bar_width, color="purple", label="rlocSet1")
plt.bar(mr, listResult_trans[1], bar_width, color="yellow", label="noMapReply")
plt.bar(mr, listResult_trans[0], bar_width, color="blue", label="negativeReply")
plt.xlabel('13 map resolvers')
plt.ylabel('percentage of every response (%)')
plt.title('Percentage of every response for 13 MRs')
